...
private var ctrlHub : Transform;// gameobject with script control variables 
private var outsideControls : controlHub;// making a link to corresponding bike's script

function Start () {

//ctrlHub = GetComponent(Transform);
////ctrlHub = GameObject.Find("gameScenario");//link to GameObject with script "controlHub"
//while(true){
//	if(ctrlHub.parent){
//		ctrlHub = ctrlHub.parent;
//	}else
//		break;
//}
outsideControls = bikeRideOn.GetComponent(controlHub);//to connect c# mobile control script to this one
...
//		Debug.LogWarning("Biker Restart!");
